...
RefreshDataSet -ClientID $ClientID -ClientSecret $ClientSecret -TenantId $TenantId -workspacename $workspacename -authority $authority -resourceAppID $resourceAppID -Admin_user_PowerBI $Admin_user_PowerBI -Admin_password_PowerBI $Admin_password_PowerBI -dataset_input $dataset_input -api_URL $api_URL
